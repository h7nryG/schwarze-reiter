...
abs1 = '''EIN SCHATTEN ERWACHT "Argh! Mein Kopf... dieses Licht ... ist das der Tod?" Dein Geist ist verwirrt und es fällt dir schwer, dich zu erheben. Nur verschwommen erkennst du einen spärlich erleuchteten Raum. Das geheiligte Symbol der Göttin Kar ist allgegenwärtig.Überall erblickst du die achtflammige Sonne: geschnitzt ins Holz des Betthimmels, gewoben in die Seide der Wandteppiche und gegossen in Gold der Kunstwerke. Du bist im großzügig ausgestatteten Schlafgemach eines Sonnenpriesters. Draußen tobt ein heftiges Unwetter. Schwerer Regen peitscht gegen das Bleiglas und für einen Augenblick wird das Zimmer in grelles Weiß getaucht. Da kracht das Fenster zurück. Die Kerzen des Kandelabers auf dem Nachttisch verlöschen. "Da ist jemand ... ein Schatten!" Du schnellst herum. Niemand. Dein Herz rast. Unerwartet stürzt du über etwas auf dem Boden und erblickst den alten Körper eines Menschen, gehüllt in die ausladende, gold gelbe Schlafkutte eines Kar-Priesters. Seine wirren, aschgrauen Haare auf dem Hinterkopf sind von Blut durchtränkt. Er regt sich nicht. "Ist er etwa tot!?" Ähnlich den Gewitterblitzen draußen zucken dir Gedanken durch den Kopf: Du hast weder eine Ahnung, wo du dich befindest, wer vor dir liegt, noch "Wer bin ICH?" Nur zögerlich und mit einer düsteren Vorahnung wandert dein Blick über das dunkle Gewand, das zerfetzt an deinem Körper herabhängt, und verharrt auf deinen zittrigen schwarzen Klauen: Blut! Das Blut des Mannes zu deinen Füßen! "Oh, nein ... Was habe ich getan?" Du willst nur fort von diesem Ort, fort von dieser Tat, als Schrittgeräusche an dein Ohr dringen.'''
...
string_proto_pfad = [
            "abs1", "abs72", "abs76", "abs55", "abs92", "abs35", "abs40", "abs71",
            "abs90", "abs65", "abs11", "abs60", "abs16", "abs89", "abs58", "abs33",
            "abs13", "abs38", "abs100"
        ]